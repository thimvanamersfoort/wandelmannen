...
function editContents()
{
    ...
    if(input.value == "")
    {
        output.innerHTML = "<i>Typ iets in het inhoudsvakje om een voorbeeld te genereren! <br>Als je al tekst getypt hebt, maar komt deze niet tevoorschijn, druk dan op een willekeurige toets in het tekstvakje.</i>"
    }
    else
    {
