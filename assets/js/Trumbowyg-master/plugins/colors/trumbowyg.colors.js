...
(function ($) {
		...
		plugins: {
			color: {
				init: function (trumbowyg) {
					trumbowyg.o.plugins.colors =
						trumbowyg.o.plugins.colors || defaultOptions;
					var dropdownClass = trumbowyg.o.plugins.colors.displayAsList
						? trumbowyg.o.prefix + "dropdown--color-list"
						: "";
	...
	function buildDropdown(fn, trumbowyg) {
		var dropdown = [],
			...
			colorList =
				trumbowygColorOptions[fn + "List"] || trumbowygColorOptions.colorList;
		...
		// Custom color
		if (
			trumbowygColorOptions[
				"allowCustom" + fn.charAt(0).toUpperCase() + fn.substr(1)
			]
		) {
			// add free color btn
