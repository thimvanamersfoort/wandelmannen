	...
	var ResizeWithCanvas = function (trumbowyg) {
		...
		this.reset = function () {
			...
			this.resizeImg.setAttribute(
				"style",
				"width: 100%; max-width: " +
					(this.resizeCanvas.clientWidth - 10) +
					"px; height: auto; max-height: " +
					(this.resizeCanvas.clientHeight - 10) +
					"px;"
			);
		...
		this.setup = function (img, resizableOptions) {
			...
			$(this.resizeCanvas)
				.on("mousemove", function (e) {
					...
					_this.ctx.rect(
						_this.resizeCanvas.width - 10,
						_this.resizeCanvas.height - 10,
						9,
						9
					);
				...
				init: function (trumbowyg) {
					...
					function initResizable() {
						trumbowyg.$ed
							...
							.on("click", function (e) {
								...
								resizeWithCanvas.setup(
									this,
									trumbowyg.o.plugins.resizimg.resizable
								);
					...
					trumbowyg.$c.on("tbwinit", function () {
						...
						trumbowyg.$ed.on("click", function (e) {
							...
							if (
								$(e.target).is("img") ||
								e.target.id === resizeWithCanvas.canvasId()
							) {
								return;
							}
