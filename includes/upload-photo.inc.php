...
{   
    if(empty($_POST['title']) || empty($_POST['description']) || empty($_POST['contents']))
    {
    ...
    else
    {
        ...
        {
            $_SESSION['post_PathToImage'] = chopStringToRoot(__FILE__) .'\images\placeholder.gif';
        ...
        else
        {
            ...
            {   
                ...
                if(!empty($post_PathToImage)) // geen errors gevonden bij min 1 foto
                {
                ...
                else // errors gevonden bij alle fotos
                {
                    header("Location: upload-post.inc.php");
                    exit();
                }
            }
            else //geen fotos geupload
            {
                header("Location: upload-post.inc.php");
                exit();
            }
