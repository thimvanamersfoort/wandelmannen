    ...
    if(isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['comment']) && !empty($_POST['comment'])){
        ...
        else
        {
            ...
            if($row = mysqli_fetch_assoc($result))
            {
                ...
                if(!mysqli_stmt_prepare($stmt, $sql))
                {
                    header("Location: ../post.php?postId=".$postId."&error=sqlError2");
                    exit();
                }
                else{
                    ...
                    header("Location: ../post.php?postId=".$postId."#allcomments-header");
                    exit();
                }
            }
        }
        ...
        header("Location: ../post.php?postId=".$postId."&error=emptyFields#newcomment-header");
        exit();
    }
}
else{
