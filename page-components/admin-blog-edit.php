            ...
            <?php if ($resultCheck > 0) {
            	...
            	foreach ($array as $key => $value) {
            		...
            		echo '<td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 175px;">
                        <a style="border-bottom: none;" href=post.php?postId=' .
            			$array[$key]['id'] .
            			'>' .
            			$array[$key]['title'] .
            			'</a></td>';

            		echo '<td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; font-size:80%; font-style:italic;">' .
            			$array[$key]['description'] .
            			'</td>';
            		echo '<td style="font-style: italic;">' .
            			$array[$key]['author'] .
            			'</td>';
            		echo '<td style="font-style: italic; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 125px;">' .
            			$array[$key]['dateCreated'] .
            			'</td>';
            		echo '<td><a href="edit.php?postId=' .
            			$array[$key]['id'] .
            			'" class="icon regular fa-edit"></a>';
            		echo '</tr>';
            	}
            } else {
            	echo '<tr>';
