...
class HttpClientsFactory
{
	...
	public static function createHttpClient($handler)
	{
		...
		throw new InvalidArgumentException(
			'The http client handler must be set to "curl", "stream", "guzzle", be an instance of GuzzleHttp\Client or an instance of Facebook\HttpClients\FacebookHttpClientInterface'
		);
	}
