	...
	PseudoRandomStringGeneratorInterface
{
	...
	public function __construct()
	{
		...
		if (!is_readable('/dev/urandom')) {
			throw new FacebookSDKException(
				static::ERROR_MESSAGE . 'Unable to read from /dev/urandom.'
			);
		}
	}
	...
	public function getPseudoRandomString($length)
	{
		...
		if (!is_resource($stream)) {
			throw new FacebookSDKException(
				static::ERROR_MESSAGE . 'Unable to open stream to /dev/urandom.'
			);
		}
		...
		if (!$binaryString) {
			throw new FacebookSDKException(
				static::ERROR_MESSAGE . 'Stream to /dev/urandom returned no data.'
			);
		}
